function [pointList,trainingLabels,patchInfo] = trainingDataAndLabels_v12_intraPatchInterPatch(META)
    ...
    for imgIndex = lowerLim:upperLim
        ...
        %%fixation points
        META.image=image;
        META.curFile=filename;
        [resized_image,densityFix,FixPoints,y,x,maxProb]=getFixationKDE_v4(META);
