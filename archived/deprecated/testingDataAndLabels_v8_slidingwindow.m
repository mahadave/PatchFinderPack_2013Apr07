function [pointList,trainingLabels,indexList,centerList] = testingDataAndLabels_v8_slidingwindow(trainingLimits,NPoints,slider)
...
%        [resized_image,densityFix]=getFixationKDE(image,users,filename);
        ...
        for i=1:slider:(size(resized_image,1)-boxSize)
            for j=1:slider:(size(resized_image,2)-boxSize)
                ...
                center = [centerX centerY imageCount];
