function [ListSet,patchInfo] = testingDataAndLabels_v13_intraPatchInterPatch(META)
    ...
    tic; [ListSet,patchInfo] = trainingDataAndLabels_v14_intraPatchInterPatch(META,META.testLimits); toc;
