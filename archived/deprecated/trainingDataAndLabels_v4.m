function [pointList,trainingLabels,indexList] = trainingDataAndLabels_v4(trainingLimits,NPoints)
...
% 
%                                    
%                                    [dissimilarityMatrix] = getSelfSimData_2(patch);
...
%                                    selection = pixelLoc;
% 
%                                     figure,imshow(resized_image); hold on;
...
%                                         rectangle('Position', boxRect, 'LineWidth',2,'LineStyle','--','EdgeColor','y');
%                                     end
%                                     hold off;
%                        
