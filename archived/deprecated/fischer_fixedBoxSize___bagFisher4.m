...
upperLim=lowerLim-1+A;%length(files); %replace with length(files) for last file
...
%labelList = labelList';    
%%
SMO_OptsStruct = svmsmoset('MaxIter', 250000);
...
upperLimTest=upperLim; %replace with length(files) for last file
