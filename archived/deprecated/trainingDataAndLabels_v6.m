function [pointList,trainingLabels,indexList,patchDistData] = trainingDataAndLabels_v6(trainingLimits,NPoints)
...
%         
        ...
        patchDistData(imgIndex).data = [corrMax ;patchLabelList];
         disp('done');
