function [histograms] = getINTERPatchDistHistogram(curImgPatchInfo,dims,NBins)
...
% create inter patch self similarity distance histogram
    ...
    for k=1:length(curImgPatchInfo.patchData)
        ...
        descriptors(k).data = getSelfSimData_inter(patch_res);            
    end
    ...
    for i=1:L
            ...
            neighbours =  findNeighbours(i,2*boxSize,dims,L);
